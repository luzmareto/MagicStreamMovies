...
const Register = () => {
    ...
    // Regex: Minimal 1 Huruf Besar, Minimal 1 Simbol, Panjang > 8 (artinya min 9)
    ...
    const handleSubmit = async (e) => {
        ...
        // Cek Validasi Password sebelum submit
        ...
        <Container className="login-container d-flex align-items-center justify-content-center min-vh-100">
            <div className="login-card shadow p-4 rounded bg-white" style={{ maxWidth: 400, width: '100%' }}>
                <div className="text-center mb-4">
                    {/* Pastikan Anda sudah mengimport logo atau hapus baris ini jika error */}
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control
                            ...
                            required
                            isInvalid={isPasswordInvalid} // Trigger merah jika invalid
                        />
                        <Form.Control.Feedback type="invalid">
                            Password harus lebih dari 8 karakter, memiliki minimal 1 huruf besar, dan 1 simbol.
